...
namespace NeuralTrainings
{
    class NeuralNetwork
    {
        ...
        public enum Figure { UpArrow, DownArrow, LeftArrow }; // образы
        ...
        public Tuple<int, int> GetConclusion(int[,] imageOnes)
        {
            ...
            {
                case 0:
                    FigureType = Figure.UpArrow;
                    break;

                case 1:
                    FigureType = Figure.DownArrow;
                    break;

                case 2:
                    FigureType = Figure.LeftArrow;
                    break;

                default:
                    throw new Exception("Ошибка в классе NeuralNetwork.");
            }
        ...
        public Figure FigureType { get; private set; }
    }
}