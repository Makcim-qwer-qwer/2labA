...
namespace NeuralTrainings
{
    ...
    public partial class Form1 : Form
    {
        ...
        int ratio = 10, size = 0; // кофициент сжатия поверхности
        ...
        private void RecognitionBtn_Click(object sender, EventArgs e)
        {
            ...
            if (WorkMode == WorkMode.Study)
                dialogResult = MessageBox.Show("Это " + neuralNetwork.FigureType.ToString() + " ?", "Помоги...", MessageBoxButtons.YesNo);
            else
                MessageBox.Show("Это " + neuralNetwork.FigureType.ToString() + " !");
